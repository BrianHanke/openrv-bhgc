...
class: OpenRVHelpMenuMinorMode : MinorMode
{
    ...
    method: OpenRVHelpMenuMinorMode (OpenRVHelpMenuMinorMode;)
    {
        Menu menuList = Menu {
                ...
                {"   RV User Manual",   opUrl(,"https://aswf-openrv.readthedocs.io/en/latest/rv-manuals/rv-user-manual/rv-user-manual-chapter-one.html"), nil},
                ...
                {"   Mu User Manual",    opUrl(,"https://github.com/AcademySoftwareFoundation/OpenRV/blob/main/docs/rv-manuals/rv-mu-programming.md"), nil},
                {"_",                   nil},
