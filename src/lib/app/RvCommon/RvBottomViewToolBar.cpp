...
RvBottomViewToolBar::build()
{
    ...
    for (size_t i = 0; i < 5; i++)
    {
        ...
        switch (i)
        {
          case 0:
              ...
              a->setToolTip("Toggle Session Manager (X)");
              m_smAction = a;
              break;
          case 1:
              a->setIcon(QIcon(":/images/paint_48x48.png"));
              a->setToolTip("Toggle Annotation tools (F10)");
              m_paintAction = a;
              break;
          case 2:
              a->setIcon(QIcon(":/images/about_48x48.png"));
              a->setToolTip("Toggle Image Info (F4)");
              m_infoAction = a;
              break;
          //case 3:
          ...
          case 3:
              ...
              a->setToolTip("Toggle Timeline Magnifier (F3)");
              m_timelineMagAction = a;
              break;
          case 4:
              a->setIcon(QIcon(":/images/timeline.png"));
              a->setToolTip("Toggle Timeline (F2)");
    ...
    b->setToolTip("Step back one frame (Left arrow)");
    b->setProperty("tbstyle", QVariant(QString("left")));
    b->setToolButtonStyle(Qt::ToolButtonIconOnly);
    m_backStepAction = a;
    ...
    b->setToolTip("Step forward one frame (Right arrow)");
    b->setProperty("tbstyle", QVariant(QString("right")));
    b->setToolButtonStyle(Qt::ToolButtonIconOnly);
    ...
    b->setToolTip("Play forwards (Space)");
    b->setProperty("tbstyle", QVariant(QString("right")));
    b->setProperty("tbsize", QVariant(QString("double")));
    b->setToolButtonStyle(Qt::ToolButtonIconOnly);
