...
\: buildViewMenu (Menu;)
{
    Menu a = {
        ...
        {"_", nil},
        {"Linear to Display Correction", Menu {
   ...
   Menu exportMenu = Menu {
    ...
    Menu mainMenu_part1 = {
        {"File", Menu {
            ...
            {"Clear Session",           ~clearEverything, "control N", nil},
            {"_", nil},
        ...
        {"Edit", Menu {
            ...
            {"Clear Marks in Range",          ~clearMarksInRange,  nil,     hasMarksState},
            {"_", nil},
        ...
        {"Play", Menu {
            {"Play",            ~togglePlayFunc,     "Space", playState},
            ...
            {"_", nil},
            {"Step Forward",    ~stepForward1,   "right", rangeState},
            {"Step Backward",   ~stepBackward1,  "left", rangeState},
            {"_", nil},
            ...
            {"_", nil},
            {"Playback Frame Rate",    nil, nil, inactiveState},
        ...
        {"Image", Menu {
                ...
                //{"Stereo", Menu {
                    ...
                    //}},
            {"_", nil},
            {"Flip Vertically",            ~toggleFlip, "Y", toggleFlipState},
            {"Flip Horizontally",            ~toggleFlop, "X", toggleFlopState},
            {"_", nil},
        ...
        {"Color", Menu {
            ...
            {"_", nil},
            {"File Nonlinear to Linear Conversion", Menu {
